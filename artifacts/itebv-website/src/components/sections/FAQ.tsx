...
export const faqItems = [
  ...
  { question: "Was passiert, wenn Sie als Einzelperson ausfallen?", answer: "Ihr Risiko ist abgesichert: Alles, was ich entwickle, gehört Ihnen – Quellcode, Dokumentation und Deployment, ohne Lizenz- oder Lock-in-Klauseln. So kann jeder andere Dienstleister nahtlos übernehmen. Für Umsetzung und Betrieb steht zudem mein festes Spezialisten-Netzwerk bereit, das ich persönlich steuere." },
