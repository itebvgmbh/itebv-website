...
export const metadata: Metadata = {
  ...
  description:
    "ITEBV entwickelt individuelle Geschäftssoftware, die zu Ihrem Unternehmen passt. Keine Lizenzkosten, keine Abhängigkeit, Software, die Ihnen gehört.",
};
      ...
      <section className="section-padding bg-bg-alt">
        <div className="container-narrow">
          ...
          <div className="prose prose-lg text-text-light max-w-none space-y-4">
            <p>
              Sie haben ein CRM, das Ihre Vertriebsprozesse nicht abbildet. Ein
              ERP, an das Sie sich anpassen statt umgekehrt. Oder gar kein
              System, und alles läuft über Excel und Workarounds.
            </p>
            <p>
              Individuelle Software klingt nach Großprojekt, nach Risiko, nach
              sechs Monaten Wartezeit und sechsstelligen Budgets. Das muss nicht
              so sein.
            </p>
          </div>
        </div>
      ...
      <section className="section-padding bg-bg">
        <div className="container-narrow">
          ...
          <p className="text-lg text-text-light mb-10">
            ...
            individuelle Software heute schneller und günstiger realisierbar als
      ...
      <section className="section-padding bg-bg-alt">
        <div className="container-narrow">
          ...
          <p className="text-lg text-text-light">
            ...
            von einem Anbieter. Eine Lösung, die genau das tut, was Sie brauchen,
            und die sich weiterentwickeln lässt, wenn sich Ihre Anforderungen
            ändern.
          </p>
        </div>
      </section>
      ...
      <section className="section-padding bg-bg">
        <div className="container-narrow">
          ...
          <p className="text-lg text-text-light">
            ...
            spezielle Anforderungen haben, die kein Tool von der Stange abdeckt.
            Die einen erfahrenen Ansprechpartner suchen, der die Lösung nicht nur
            umsetzt, sondern auch versteht, warum sie so umgesetzt werden muss.
          </p>
        </div>
      </section>
